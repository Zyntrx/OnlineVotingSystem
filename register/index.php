                         ...
                         <form method = "post" enctype = "multipart/form-data">
                                ...
                                <div class="form-heading">
                         		<center>Voter Registeration</center>
											...
											<div class="form-field">
												<label>Program of Study <i>(enter initials only i.e BSIT,BSTM, BSIS..)</i></label><br/>
													<input class="form-control"  type = "text" name = "prog_study" placeholder="i.e BSIT,BSTM, BSIS.." required="true">
											</div>
